...
int main(int argc, char **argv) {
  ...
  if (argc == 2 && !strcmp(argv[1], "ready")) {
    puts("{\"schemaVersion\":\"local-control-ready-v1\"}");
    return 0;
  }
