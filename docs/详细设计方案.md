...
12.1设计验收：R01–R10覆盖后端/依赖/配置/安装启动恢复/文档/Eval；§12.3.11.2覆盖新状态所有权和旧数据拒绝；V01–V12及§12.3.11.5覆盖保留契约、本机替代与专属测试退役；§12.3.11.6覆盖顺序、失败与证据。12.2尚待定稿的强制保护机制是已有任务边界，不阻塞本清单接受，也不构成宿主执行授权。本任务没有强制打包/协议Spike；本轮仅文档审阅，未执行任何产品G5。
