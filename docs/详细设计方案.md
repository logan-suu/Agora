...
- **Phase 7**：加入角色增删、强制交接、接手与 Coordinator 不可删除；权威检查只覆盖 Leader 发起成员生命周期动作、Coordinator 恒 enabled、孤儿职责升级 humanGate，不提前覆盖 Phase 8 的 authority 覆盖与异议裁决。`[2026-09-03 规格澄清]`
